...
def dt_IMp(dt:DateTime|Time, *, compact:bool=False) -> str:
...
def dt_interval_IMp(start:DateTime|Time, end:DateTime|Time, *, compact:bool=False) -> str:
...
def dt_interval_Ymd_IMp_IMp(start:DateTime, end:DateTime|Time, compact:bool=False) -> str:
  '''
