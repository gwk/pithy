...
def write_dot_digraph_adjacency(f: TextIO, adjacency:GraphvizAdjacency, nodes:GraphvizNodes|None=None, **kwargs:Any) -> None:
...
def out_dot_digraph_adjacency(adjacency:GraphvizAdjacency, **kwargs:Any) -> None:
