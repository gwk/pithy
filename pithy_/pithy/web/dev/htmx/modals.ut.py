...
def _() -> None:
  ...
  try:
    ...
    updates = (({'name': 'Alex Chen'}, 'Alex Chen'), ({'role': 'Viewer'}, 'Viewer'), ({'vip': 'true'}, 'Yes'),
      ({'ui': 'dark'}, 'Dark'))
    ...
    saved = users.copy()
    for invalid in ({'name': ' '}, {'role': 'Owner'}, {'vip': 'maybe'}, {'ui': 'sepia'}, {},
      {'name': 'Alex', 'role': 'Viewer'}, {'vip': 'false', 'ui': 'light'}):
