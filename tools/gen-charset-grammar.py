...
def main() -> None:
  ...
  print('// Generated by github.com/gwk/legs gen-charset-grammar.py.')
  print()
  print('# License: Dedicated to the public domain under CC0: https://creativecommons.org/publicdomain/zero/1.0/.')
  print()
  print('# Patterns')
  print()
  print('newline: \\n')
