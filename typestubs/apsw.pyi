...
class Connection:
  filename:str
  open_flags:int = ...
  open_vfs:Optional['VFS'] = None
  statementcachesize:int = ...

  def __init__(self, filename:str, flags:int=..., vfs:Optional['VFS']=None, statementcachesize:int=...) -> None: ...
...
class Cursor:
  ...
  def setexectrace(self, trace:Optional[Callable]) -> None: ...

  def setrowtrace(self, trace:Optional[Callable]) -> None: ...
...
class blob:
  ...
  def __exit__(self, exc_type:OptTypeBaseExc, exc_value:OptBaseExc, traceback:OptTraceback) -> Optional[bool]: ...
