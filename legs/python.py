...
from legs_base import DictLexerBase, RegexLexerBase, ModeData, ModeTransitions
from re import compile as _re_compile
from typing import Dict, Iterator, Pattern, Tuple


_mode_transitions:ModeTransitions = ${mode_transitions}


_pattern_descs:Dict[str,str] = ${pattern_descs}


class ${Name}Lexer(DictLexerBase):

  pattern_descs:Dict[str,str] = _pattern_descs
  mode_transitions:ModeTransitions = _mode_transitions
